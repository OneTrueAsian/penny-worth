...
export const CHANGELOG: Record<string, string[]> = {
  ...
  "1.2.4": [
    "A new visual theme, Slate, replaces Classic as Penny Worth's default look — a refreshed palette, typography, and iconography. Aurora and Midnight Emerald have been retired; Futuristic remains as the other option.",
    ...
    "Fixed: Reports' \"Income (all-time)\" stat, the Savings Rate Trend, Ask Pennyworth, and Household's income-by-person could all read $0 or an incorrect total for a paycheck not categorized literally \"Income\" (e.g. \"Salary\") — income is now calculated the same consistent way everywhere, matching Cash Flow.",
